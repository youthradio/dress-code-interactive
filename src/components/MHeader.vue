      ...
      <footer>
        ...
        <div>
          <ul
            ...
            >
              <a href="https://yr.media/about-yr/">About YR</a>
            </li>
            <li
              id="menu-item-38684"
              class="menu-item menu-item-type-post_type menu-item-object-page menu-item-38684"
            >
              <a href="https://yr.media/partners/">Our Partners</a>
            </li>
            <li
              id="menu-item-35671"
              class="menu-item menu-item-type-post_type menu-item-object-page menu-item-35671"
            >
              <a href="https://yr.media/supporters/">Our Supporters</a>
            </li>
            <li
              id="menu-item-35672"
              class="menu-item menu-item-type-post_type menu-item-object-page menu-item-35672"
            >
              <a href="https://yr.media/donate/">Donate</a>
            </li>
            <li
              id="menu-item-42578"
